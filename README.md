...
| 神司马 | 神   | 男   | 4/4/0          | 戢鳞、英猷、应天、倾朝 |
| 神冶   | 神   | 男   | 4/4/0          | 冶武、炼刃、穷兵 |
| 神傀   | 神   | 男   | 4/4/0          | 傀体、百战、移魂 |
| 神貂蝉 | 神   | 女   | 3/3/0          | 魅魔、魅心、魅祸 |
...
当你对其他角色造成伤害时，若你拥有来源于其的技能，你令其失去一个技能直到其下一个回合结束，否则你增加一点体力上限。
...
锁定技。当你需要响应一张非延时类锦囊牌而未使用【无懈可击】时，你摸一张牌，然后若你的"志"少于5张，你将一张手牌置于你的武将牌上，称为"志"。

#### 英猷

一名其他角色的回合开始时，你可以移去至少2张花色相同的"志"，然后摸X张牌（X为你移去的"志"数）并选择一项：1、弃置其X张牌；2、令其使用的下X张牌无效；3、令其摸X张牌并跳过出牌阶段和弃牌阶段。

#### 应天

觉醒技。准备阶段，若你拥有5张"志"，你减少一点体力上限并失去【戢鳞】、【英猷】，然后获得【倾朝】、【鬼才】、【完杀】、【连破】。

#### 倾朝

锁定技。①当你失去牌时，你摸X张牌（X为你失去的牌中与任意一张"志"花色相同的牌数）；②你使用与任意一张"志"花色相同的牌无距离限制；③你使用与所有"志"花色均不相同的牌无次数限制；④当你杀死一名角色时，你移去一张"志"，然后摸3张牌。
...
锁定技。
① 当你受到伤害时，你令当前回合角色失去等量张牌。
② 当你成为其他角色使用牌的目标时，你摸一张牌或获得其一张牌。
③ 当你获得锦囊牌时，你弃置手牌区中的所有锦囊牌，然后若你的体力值不满，你恢复等量点体力，否则增加等量点体力上限。
④ 你使用牌无次数限制。
